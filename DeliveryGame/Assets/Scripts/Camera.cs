...
public class Camera : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        var rotation = Quaternion.Euler(cameraPivot.transform.rotation.eulerAngles.x - Input.GetAxis("Mouse Y") * sensitivity / 2,
        ...
        {
            var scrollAmount = Input.GetAxis("Mouse ScrollWhell") * scrollSens;
